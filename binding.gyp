    ...
    "targets": [
        {
            ...
            "sources": [
                ...
                'algorithms/cryptonote/crypto/aesb.c',
                'algorithms/cryptonote/crypto/c_blake256.c',
                'algorithms/cryptonote/crypto/c_groestl.c',
                'algorithms/cryptonote/crypto/c_jh.c',
                'algorithms/cryptonote/crypto/c_keccak.c',
                'algorithms/cryptonote/crypto/c_skein.c',
                'algorithms/cryptonote/crypto/hash.c',
                'algorithms/cryptonote/crypto/oaes_lib.c',
                'algorithms/cryptonote/crypto/wild_keccak.cpp'
            ],
            'conditions': [],
            "include_dirs": [],
            "cflags_cc": [
